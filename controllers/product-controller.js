            ...
            products: result.map(prod => {
                return {
                    ...
                    request: {
                        ...
                        url: 'localhost:3000/produtos/' + prod.productId
                    }
                }
            })
        }
        ...
        const response = {
            ...
            upatedProduct: {
                ...
                request: {
                    type: 'GET',
                    description: 'Retorna os detalhes de um produto específico',
                    url: 'localhost:3000/produtos' + req.params.productId
                }
            }
        }
        ...
        const response = {
            ...
            createdImage: {
                ...
                request: {
                    ...
                    url: 'localhost:3000/produtos/' + req.params.productId + '/imagens'
                }
            }
        }
        return res.status(201).send(response);
